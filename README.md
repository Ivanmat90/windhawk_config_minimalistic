...
> ***ПРЕДУПРЕЖДЕНИЕ!: Данная конфигурация на Windows 10 не будет работать или работать частично***
...
> **Совет: Должен быть установлен [Everything](https://voidtools.com/) с включённым индексированием: Сервис — Настройки — Индексирование — Поставить галочку "Размеры папок".**
